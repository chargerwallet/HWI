...
from test_chargerwallet import chargerwallet_test_suite
...
chargerwallet_group = parser.add_mutually_exclusive_group()
chargerwallet_group.add_argument('--no-chargerwallet-1', dest='chargerwallet_1', help='Do not run ChargerWallet Legacy test with emulator', action='store_false')
chargerwallet_group.add_argument('--chargerwallet-1', dest='chargerwallet_1', help='Run ChargerWallet Legacy test with emulator', action='store_true')

chargerwallet_t_group = parser.add_mutually_exclusive_group()
chargerwallet_t_group.add_argument('--no-chargerwallet-t', dest='chargerwallet_t', help='Do not run ChargerWallet Touch test with emulator', action='store_false')
chargerwallet_t_group.add_argument('--chargerwallet-t', dest='chargerwallet_t', help='Run ChargerWallet Touch test with emulator', action='store_true')
...
parser.add_argument('--chargerwallet-1-path', dest='chargerwallet_1_path', help='Path to ChargerWallet Legacy emulator', default='work/chargerwallet-firmware/legacy/firmware/chargerwallet_emu.elf')
parser.add_argument('--chargerwallet-t-path', dest='chargerwallet_t_path', help='Path to ChargerWallet Touch emulator', default='work/chargerwallet-firmware/core/emu.sh')
...
parser.set_defaults(trezor_1=None, trezor_t=None, coldcard=None, keepkey=None, bitbox01=None, ledger=None, ledger_legacy=None, jade=None, chargerwallet_1=None, chargerwallet_t=None)
...
if args.all:
    ...
    args.chargerwallet_1 = True if args.chargerwallet_1 is None else args.chargerwallet_1
    args.chargerwallet_t = True if args.chargerwallet_t is None else args.chargerwallet_t
    ...
    args.chargerwallet_1 = False if args.chargerwallet_1 is None else args.chargerwallet_1
    args.chargerwallet_t = False if args.chargerwallet_t is None else args.chargerwallet_t
...
if args.trezor_1 or args.trezor_t or args.chargerwallet_1 or args.chargerwallet_t or args.coldcard or args.ledger or args.ledger_legacy or args.keepkey or args.bitbox01 or args.jade:
    # Start bitcoind
    ...
    if success and args.chargerwallet_1:
        success &= chargerwallet_test_suite(args.chargerwallet_1_path, bitcoind, args.interface, '1')
    if success and args.chargerwallet_t:
        success &= chargerwallet_test_suite(args.chargerwallet_t_path, bitcoind, args.interface, 't')
